...
<?php echo Tabs::widget(array(
        'items' =>array(
            array(
                'label' => 'General',
                'content' =>$this->render('tabs/_general', array('form'=>$form,'model'=>$model,'allcountry' => $allcountry)),
                'active' => true
            ),
            /*array(
...
<div class="control-group" style="text-align: center;">
    <div class="controls">
        ...
        <?php echo Html::a('Cancel',array('/destination/index'), array('class' => 'btn btn-warning')) ?>
    </div>
</div>
<?php
ActiveForm::end();
