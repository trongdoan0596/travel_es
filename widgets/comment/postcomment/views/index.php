            ...
            <?php $form  = ActiveForm::begin(
               ...
               <div class="uk-grid">
                        <div class="uk-width-1-2">
                                ...
                                <?php echo $form->field($model,'message')->textarea(array('rows' =>10,'cols' =>50,'placeholder'=>Yii::t('app','Escribir tu mensaje aquí').' ... '));?>
                                </div>                        
                        </div>
                        <div class="uk-width-1-2">
                                 <div class="uk-form-row">
                                        <?php echo $form->field($model,'fullname')->textInput(array('class' =>'form-control','placeholder'=>Yii::t('app','Nombre completo')));?>
                                 </div>
                                 <div class="form-group">
                                        <?php echo $form->field($model,'youremail')->textInput(array('class' =>'form-control','placeholder'=>Yii::t('app','Tu email')));?>
                                 </div>
                                 <div class="uk-form-row">  
                                  <?php echo $form->field($model,'verifyCode')->widget(Captcha::className(),array('imageOptions'=>array('alt'=>'Captcha'),'template' =>'<div class="captchacode"><div class="col-code">{input}</div><div class="col-img">{image}<br /><div style="white-space: nowrap;">'.Yii::t('app','Debes escribir los caracteres de la imagen en el cuadro de texto').'</div></div></div>')); ?>
                                 </div>  
                        </div>                   
                </div>
                  <?php
