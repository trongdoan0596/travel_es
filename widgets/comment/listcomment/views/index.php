                  ...
                  $form = ActiveForm::begin(
                        ...
                        <div class="uk-width-1-1">
                                <div class="uk-form-row">
                                  <?php echo $form->field($modelfrm,'message')->textarea(array('rows' =>4,'cols' =>50,'placeholder'=>Yii::t('app','Escribir tu mensaje aquí').' ... '));?>
                                </div>
                        </div>
                        <div class="uk-width-1-1" style="margin-top: 14px;">
                                    <div class="uk-form-row">
                                      <?php echo $form->field($modelfrm,'fullname')->textInput(array('class' =>'form-control','placeholder'=>Yii::t('app','Nombre completo')));?>
                                    </div>
                            </div>
                            <div class="uk-width-1-1" style="margin-top: 14px;">
                                    <div class="uk-form-row">
                                      <?php echo $form->field($modelfrm,'youremail')->textInput(array('class' =>'form-control','placeholder'=>Yii::t('app','Tu email')));?>
                                    </div>
                            </div>
                            <div class="uk-width-1-1" style="margin-top: 14px;">
                                     <div class="uk-form-row">
                                     <div style="width: 100%; text-align: left;white-space: nowrap;"><strong>Code anti-spam</strong> <?php echo Yii::t('app','Debes escribir los caracteres de la imagen en el cuadro de texto');?></div><br />
                            ...
                            <?php 
                            echo Html::Button('<i class="uk-icon-edit"></i> '.Yii::t('app','Responder'),array('onclick' =>'ReplySubmit('.$ext_id.','.$id_ext.');','class' =>'btn btn-warning btncomment','name' =>'sendcommentreply'.$ext_,'id' =>'sendcommentreply'.$ext_));
                            ?>                             
                            </div>
                              <?php
