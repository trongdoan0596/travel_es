          ...
          <div class="uk-grid">             
             ...
             <div class="uk-width-1-2">
                <figure class="uk-overlay">
                     <a href="<?php echo $urlall;?>"><img class="border-img-4" src="<?php echo Url::base();?>/themes/web/img/article/agencia-de-viajes-vietnam.png" alt="Agencia de Viajes Vietnam" title="Agencia de Viajes Vietnam" /></a>
                </figure>  
             </div>
          </div> 
     </div>
