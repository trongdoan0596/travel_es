...
<div class="contryside">
            <h1 class="title-customizedes-tour"><?php echo Yii::t('app','Lugares interesantes');?></h1>
            <div class="uk-grid mapcustomize">
                                    ...
                                    <div class="uk-width-1-2 content">
                                        <div class="boxcustomizedes">       
                                            <div style="text-align: left !important;padding-bottom: 10px; "><?php echo Yii::t('app','Elegir los destinos en el mapa');?></div>                                     
                                             <h2>Vietnam</h2>
                                              ...
                                              <h2><?php echo Yii::t('app','Otros destinos');?></h2>
                                              <div class="item-northern">
                                               <ul id="otherdes"></ul>
                                        ...
                                        <div class="customizedes">
                                                   <h3><?php echo Yii::t('app','Otros destinos');?></h3>
                                                   <span><?php echo Yii::t('app','Escibir el lugar que quieres visitar');?></span>
