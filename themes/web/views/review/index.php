                             ...
                             <div class="txt">
                                  ...
                                  if($img_head!=""){
                                    ...
                                    <div class="uk-width-1-4">
                                      <a rel="nofollow" href="https://www.tripadvisor.es/Attraction_Review-g293924-d11641267-Reviews-Authentik_Vietnam_Travel-Hanoi.html" target="_blank"><img src="<?php echo $img_head;?>"/></a>
                                      </div>
                                    <div class="uk-width-3-4"><?php echo $fulltxt;?>                                       
                                       <div class="starfb">
                                        <i class="uk-icon-star"></i><i class="uk-icon-star"></i><i class="uk-icon-star"></i><i class="uk-icon-star"></i><i class="uk-icon-star"></i> 4.9/5 <?php echo Yii::t('app','Calculado en las opiniones de nuestros clientes en');?> <a target="_blank" href="https://www.facebook.com/authentikvietnamtravel/reviews">Facebook</a>
                                       </div>                                       
                                    </div>                                    
                                    <?php
                                  }else{
