...
$fulltxt = $tmp[0];
if(count($tmp)==2){    
    $fulltxt = $fulltxt.'<span class="remorereview" id="readmore_'.$id.'"  onclick="ShowFull('.$id.')"> ... '.Yii::t('app', 'Leer más').'</span>';
}
?>
...
?>
<span style="text-align: right;float: right;cursor: pointer;" onclick="HideAccordion(<?php echo $cate->id;?>);"><?php echo Yii::t('app', 'Leer menos');?></span>
</div>