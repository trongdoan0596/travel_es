             ...
             <div class="boxprice">             
                ...
                <ul class="uk-list">
                     <li style="padding-bottom: 10px;">
                            <label><?php echo Yii::t('app', 'Género');?></label><br />
                       ...
                       <li>     
                         <?php echo $form->field($modelform,'name')->textInput(array('class' =>'uk-form-width-large','placeholder'=>Yii::t('app','Nombre').'*'))->label(false);?>
                        </li>
                        <li>
                           <?php echo $form->field($modelform,'address')->textInput(array('class' =>'uk-form-width-large','placeholder'=>Yii::t('app','Dirección')))->label(false);?>
                        </li> 
                        <li>
                           <?php echo $form->field($modelform,'nationality')->textInput(array('class' =>'uk-form-width-large','placeholder'=>Yii::t('app','Nacionalidad')))->label(false);?>           
                        </li>                         
                        <li>
                          <?php echo $form->field($modelform,'phone')->textInput(array('class' =>'uk-form-width-large','placeholder'=>Yii::t('app','Teléfono').'*'))->label(false);?>          
                        </li>                                               
                        <li>
                           <?php echo $form->field($modelform,'email')->textInput(array('class' =>'uk-form-width-large','placeholder'=>Yii::t('app','Email').'*'))->label(false);?>          
                        </li>
                         <li>
                          <?php echo $form->field($modelform,'confirmemail')->textInput(array('class' =>'uk-form-width-large','placeholder'=>Yii::t('app','Confirmar email').'*'))->label(false);?>          
                        </li> 
                        <li>
                          <?php echo $form->field($modelform,'skype')->textInput(array('class' =>'uk-form-width-large','placeholder'=>Yii::t('app','Cuenta de Skype')))->label(false);?>          
                        </li> 
                        <li>
                          <?php echo $form->field($modelform,'whatsapp')->textInput(array('class' =>'uk-form-width-large','placeholder'=>Yii::t('app','Tu WhatsApp')))->label(false);?>          
                        </li>
                        <li>
                          <?php echo $form->field($modelform,'viber')->textInput(array('class' =>'uk-form-width-large','placeholder'=>Yii::t('app','Tu Viber')))->label(false);?>          
                        </li>
                         <li class="uk-display-inline-block boxcontact">                          
                             <label class="control-label" for="requestpriceform-hotel"><?php echo Yii::t('app', '¿Qué manera de comunicación prefieres ?');?></label> 
                        ...
                        <li>
                          <?php echo $form->field($modelform,'contacttxt')->textarea(array('class' =>'uk-form-width-large','rows'=>2,'placeholder'=>Yii::t('app','Mejor momento para teléfono o skype')))->label(false);?>          
                        </li>
                        <li class="uk-display-inline-block">
                                  <label class="control-label" for="requestpriceform-hotel"><?php echo Yii::t('app', 'Número de participantes').' *';?></label> 
                                  <div class="uk-grid uk-display-inline-block uk-position-relative uk-width-1-1" style="width: 100%;">
                                   <?php echo $form->field($modelform,'adult')->textInput(array('class' =>'uk-form-width-medium','placeholder'=>Yii::t('app','Número de participantes').'*'))->label(false);?>
                                   ...
                                   <?php echo $form->field($modelform,'children')->textInput(array('class' =>'uk-form-width-medium','placeholder'=>Yii::t('app','Niños menos de 12 años')))->label(false);?>
                                   <!--<span style="margin-top: 0px;"><?php //echo Yii::t('app', 'Children under 12 years old');?> </span>-->
                               </div> 
                        </li>
                          <li class="uk-display-inline-block boxage">                          
                        ...
                        <li class="uk-display-inline-block">      
                           <div class="uk-width-1-1" style="padding-left:0px;margin-left: 0px;padding-top: 20px;">
                            <div class="radio-item" style="width: 335px;float: left; white-space: nowrap;display: block;">                                
                                <label for="requestpriceform-traveldate_id2" style="cursor: pointer;"><?php echo Yii::t('app', 'Si no, ¿ En qué mes prefieres ?');?></label>                       
                            </div>
                      ...
                      <li class="uk-display-inline-block" style="display: block;width: 100%;">                          
                             <label class="control-label" for="requestpriceform-meals" style="width: 100%;"><?php echo Yii::t('app', 'Comidas');?></label> 
                             <div class="uk-form-row boxmeals" style="float: left;width: 100%;">       
                             <?php
                        ...
                        <br />
                       <li class="uk-display-inline-block" style="width: 100%;">
                             <label class="control-label" for="requestpriceform-hotel" style="width: 100%;"><?php echo Yii::t('app', 'Hotel');?></label> 
                         ...
                         <div class="uk-form-row" style="text-align: left;padding-left:0px">
                               <?php echo $form->field($modelform,'verifyCode')->widget(Captcha::className(),array('imageOptions'=>array('alt'=>'Captcha'),'template' =>'<div class="captchacode" align="center"><div class="col-lg">{input}</div><div class="col-lg">{image}</div></div>'))->label(true); ?>
                             <div style="margin-top: -10px;"><?php echo Yii::t('app','Tienes que escribir los caracteres de la imagen en el cuadro de texto');?></div>
                          </div>                                 
                        </li>
                        <?php 
              ...
              <div style="text-align: center !important;padding-top:0px;padding-bottom: 20px;">
                  ...
                  &nbsp&nbsp&nbsp <?php echo Html::submitButton(Yii::t('app','Enviar').'  <i class="uk-icon-angle-double-right"></i>',array('class' =>'btn btn-warning clsback', 'name' => 'sendrequest')) ?>
             </div>
</div>                
 <?php 
 ActiveForm::end();
...
function ChangeHowDid(id){ 
          switch(id){
                case 1:
                     $("#customizeform-howdidtxt").attr("placeholder","<?php echo Yii::t('app','Ingresar tu texto aquí');?>");                
                    break;
                case 2:
                    $("#customizeform-howdidtxt").attr("placeholder","<?php echo Yii::t('app','Ingresar tu texto aquí');?>");   
                    break;
               ...
               case 4:
                    ...
                    break;
                case 4:
                     $("#customizeform-howdidtxt").attr("placeholder","<?php echo Yii::t('app','Escribir el texto aquí');?>");  
                    break;     
        }
}
